...
- **产品全景规划**：参见 [产品需求文档（PRD）核心摘要.md](./产品需求文档（PRD）核心摘要.md)。本项目整体规划采用分阶段演进路线（V0.1 单机 MVP → V0.2 扫码 → V0.3 提醒 → V0.4 完善 → V0.5 主题 → V0.6-V0.9 AI 与 NAS → V1.0+ 完整生态）；本文档当前聚焦于 V0.1 单机 MVP 的功能边界、技术约束与核心验收标准（AC），后续版本将在当前基线稳定后增量补充。
